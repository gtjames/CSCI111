...
Write a C++ program to solve the Kattis problemid dfyrirdreki: [https://open.kattis.com/problems/dfyrirdreki](https://open.kattis.com/problems/dfyrirdreki). Note that the last part of the URL, e.g. `dfyrirdreki` is the problem id. Read the problem statement carefully to design a correct solution.
